        ...
        >
          <div className={styles.subContainer}>
            <a href="#" className={styles.Schlogo}>
              <img src={LOGO} className={styles.logo_form} alt="School Logo" />
            </a>
          ...
          <div className={styles.form}>
            ...
            <div className={styles.formControler}>
              <label htmlFor="ffname">Fathers First Name</label>
              <input
                type="text"
                name="ffname"
                id="ffname"
            ...
            <div className={styles.formControler}>
              <label htmlFor="flname">Fathers Last Name</label>
              <input
                type="text"
            ...
            <div className={styles.formControler}>
              <label htmlFor="mfname">Mothers First Name</label>
              <input
                type="text"
                name="mfname"
                onChange={getValue}
            ...
            <div className={styles.formControler}>
              <label htmlFor="mlname">Mothers Last Name</label>
            ...
            <div className={styles.formControler}>
              <label htmlFor="locname">Local Guadians First Name:</label>
              <input
                type="text"
                name="locname"
                id="locname"
            ...
            <div className={styles.formControler}>
              <label htmlFor="loclname">Local Guadians Last Name:</label>
              <input
                type="text"
                name="loclname"
                id="loclname"
